                        ...
                        >
                          ...
                          <div>
                            ...
                            <p className="text-xs text-white/50 shrink-0 group-hover:text-white transition-colors duration-300">
                              Website doanh nghiệp, landing page, thương mại
                              điện tử, dịch vụ, đặt lịch
                            </p>
                          </div>
                        </Link>
                      </li>
                      <li>
                        ...
                        >
                          ...
                          <div className="leading-5 w-max">
                            ...
                            <p className="text-xs text-white/50 shrink-0 group-hover:text-white transition-colors duration-300">
                              Tối ưu hóa website lên top Google bền vững với
                              chiến lược SEO chuyên nghiệp
                            </p>
                          </div>
                        </Link>
                      </li>
                      <li>
                        ...
                        >
                          ...
                          <div className="leading-5 w-max">
                            ...
                            <p className="text-xs text-white/50 shrink-0 group-hover:text-white transition-colors duration-300">
                              Quảng cáo Google Ads hiệu quả, tăng doanh thu
                              nhanh chóng với chi phí tối ưu
                            </p>
                          </div>
                        </Link>
                      </li>
                      <li>
                        ...
                        >
                          ...
                          <div className="leading-5 w-max">
                            ...
                            <p className="text-xs text-white/50 shrink-0 group-hover:text-white transition-colors duration-300">
                              Chiến lược Digital Marketing tổng thể, xây dựng
                              thương hiệu và tăng trưởng bền vững
                            </p>
                          </div>
                        </Link>
                      </li>
                      ...
                      <li>
                        <Link href='/ui-ux-design' className="flex gap-3">
                          ...
                          <div className="leading-5 w-max">
                            ...
                            <p className="text-xs text-white/50 shrink-0 group-hover:text-white transition-colors duration-300">
                              Logo, nhận diện thương hiệu, trải nghiệm người
                              dùng (UX)
                            </p>
                          </div>
                        </Link>
