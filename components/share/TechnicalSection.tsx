...
const TechnicalSection = () => {
    return (
        <section id="technologies" className="py-16 md:py-24 text-white">
            <div className="container mx-auto px-4">
                ...
                <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 mb-12">
                    {designWebDataPage.technologies.map((card, idx) => (
                        <motion.div
                            key={idx}
                            className="rounded-lg border shadow-md hover:shadow-lg transition-shadow duration-300 border-white  text-white"
                ...
                <motion.div
                    className="text-center  border border-white rounded-2xl p-8 shadow-lg"
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
                    viewport={{ once: true }}
                    transition={{ duration: 0.5 }}
